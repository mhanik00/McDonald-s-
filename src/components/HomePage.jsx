  ...
  return (
    <div>
      ...
      <div className="flex justify-center my-2">
        ...
        <motion.a
          href="https://example.com/claim-gift-card" // Link to claim the gift card
      ...
      <div className="flex flex-col md:flex-row justify-center items-center my-4">
        ...
        <div>
          ...
          <div className="flex flex-col justify-center my-4">
            ...
            <motion.a  
              href="https://example.com/get-chicken-big-mac" // Link to get the Chicken Big Mac
      ...
      <div className="flex flex-col md:flex-row justify-center items-center my-4">
        ...
        <div>
          ...
          <div className="flex flex-col justify-center my-4">
            ...
            <motion.a
              href="https://example.com/get-free-big-mac" // Link to get the free Big Mac
              className="bg-[#fcb808] text-[#292929] px-8 md:px-12 py-4 rounded-md 
                   text-lg
                   font-semibold
                   transition-transform transform hover:scale-105 hover:shadow-lg
